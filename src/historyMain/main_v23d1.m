...
resPathName="/work/Wei/Projects/WholeFishAnalyss/dat/230119_f389/" + ...
    "230119_f389-230216-v23d1_jump20_penalty1";
...
motion_history=zeros([round([X Y Z]/2^option.larer),3,initialLength],"single");
...
for tCnt=1:length(tRange)
    ...
    % motion correction
    disp("correct motion...");
    motion_current=getMotion_Wei_v23d1(dat_mov_norm,dat_ref,smoothPenalty,option);
