...
resPathName="/work/Wei/Projects/WholeFishAnalyss/dat/230119_f389/230119_f389-230216-v21_jump20_penalty1_motionDecay50";
...
for tCnt=1:length(tRange)
    ...
    option.motion=motionDecayFactor*option.motion+(1-motionDecayFactor)*motion_current;
    toc;
    % save motion
    disp("save motion...");
