...
resPathName="/work/Wei/Projects/WholeFishAnalyss/dat/230119_f389/230119_f389-230216-v22_jump20_penalty1";
...
option.motion=[];
option.motion_ref=zeros([X,Y,Z,3]);
...
for tCnt=1:length(tRange)
    ...
    % motion correction
    disp("correct motion...");
    motion_current=getMotion_Wei_v22(dat_mov,dat_ref,smoothPenalty,option);
    ...
    option.motion_ref=option.motion_ref*motionDecayFactor+motion_current*(1-motionDecayFactor);
    toc;
    % save motion
    disp("save motion...");
