...
resPathName="/work/Wei/Projects/WholeFishAnalyss/dat/230119_f389/230119_f389-230216-v20_jump20_penalty1_highFreq50";
...
for tCnt=1:length(tRange)
    ...
    % motion correction
    disp("correct motion...");
    motion_current=getMotion_Wei_v20(dat_mov_norm,dat_ref,smoothPenalty,option);
