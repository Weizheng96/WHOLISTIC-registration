...
resPathName="/work/public/Virginia Rutten/Result/230324_f479/230324_f479-230421_HZRv2d2_r5p1_jump20";
%% parameters
option.layer=3;
option.iter=10;
option.r=5;
...
%%
implay(double(squeeze(dat_corrected2(:,:,6,1:20:end)))/700)
...
%%
bfsave(dat_corrected1, 'CorrectedCh1.ome.tiff');