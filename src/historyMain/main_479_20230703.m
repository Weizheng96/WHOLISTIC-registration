...
%% file path
filePath="/work/public/Virginia Rutten/230324_f479_ubi_gcamp_bactin2_mcherry_9dpf_hypoxia_tiles/mat";
resPathName="/work/public/Virginia Rutten/230324_f479_ubi_gcamp_bactin2_mcherry_9dpf_hypoxia_tiles" + ...
    "/f479_HZRv2d2_r5_p0d02_20230703";
%% parameters
option.layer=3;
option.iter=10;
option.r=5;
smoothPenalty_raw=0.02;
...
for tCnt=1:length(tRange)
    ...
    % read data
    disp("read data (1)...");
    load(fullfile(filePath,"dat"+t+".mat"),"dat_ch1","dat_ch2");
