...
resPathName="/work/Wei/Projects/WholeFishAnalyss/dat/221124_f338/221124_f338-230326-FWv2_r5p1R12P10_noInitial_oneshot";
...
dat_corrected2=zeros([X,Y,Z,1,length(tRange)],"uint16");
dat_raw1=zeros([X,Y,Z,1,length(tRange)],"uint16");
dat_raw2=zeros([X,Y,Z,1,length(tRange)],"uint16");
