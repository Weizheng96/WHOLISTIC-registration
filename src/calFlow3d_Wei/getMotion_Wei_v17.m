function motion_current=getMotion_Wei_v17(dat_mov,dat_ref,smoothPenalty_raw,option)
...
%     fprintf("\nDownsample:"+layer+"\n");
    for iter = 1:iterNum
        ...
        neiSum=smoothPenalty*(getNeiSum2(motion_current(xG,yG,zG,:),1)/8-motion_current(xG,yG,zG,:))*patchConnectNum;
