function motion_current=getMotion_Wei_v16d2(dat_mov,dat_ref,smoothPenalty_raw,option)
...
%         stepFactor=min((iter-1)/3,1);
        ...
        motion_update=getFlow3_withPenalty5(Ixx,Ixy,Ixz,Iyy,Iyz,Izz,Ixt,Iyt,Izt,motion_current,smoothPenaltySum,r,zRatio);
