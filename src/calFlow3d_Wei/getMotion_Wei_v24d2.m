function [motion_current,currentError,x_new,y_new,z_new]=getMotion_Wei_v24d2(dat_mov,dat_ref,smoothPenalty,option)
%% v24d2: based on v24d1, slower but fewer memory
...
for layer = layer_num:-1:0
    ...
    data1 = imresize3(dat_mov, [x,y,z]);
    data2 = imresize3(dat_ref, [x,y,z]);
    zRatio=zRatio_raw;
    ...
    if layer == layer_num
        ...
        motion_current=upsampleMotion(motion_current,x,y,z);
    end
