function phi_current=getMotion_Wei_v6d1(dat_mov,dat_ref,smoothPenalty)
%% v6: new gradient calculation, penalty always there
...
for layer = layer_num:-1:0
    ...
    for iter = 1:iterNum
        ...
        stepFactor=1;%min((iter-1)/(iterNum-2),1);
