function motion_current=getMotion_Wei_v14(dat_mov,dat_ref,smoothPenalty_raw)
%% v14: conformal
...
%         stepFactor=min((iter-1)/3,1);
        ...
        neiSum=smoothPenalty*stepFactor*getNeiSum2(motion_current,r)/(patchConnectNum-1)*patchConnectNum;
