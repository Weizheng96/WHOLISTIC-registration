function motion_current=getMotion_Wei_v17d6(dat_mov,dat_ref,smoothPenalty_raw,option)
%% v17d6: new motion range with early stop
...
%     fprintf("\nDownsample:"+layer+"\n");
    for iter = 1:iterNum
        ...
        [diffError,penaltyError]=calError(It,neiDiff,smoothPenaltySum,zRatio);
