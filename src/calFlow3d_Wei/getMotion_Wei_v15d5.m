function motion_current=getMotion_Wei_v15d5(dat_mov,dat_ref,smoothPenalty_raw,option)
%% v15d5: new penalty term
...
%         stepFactor=min((iter-1)/3,1);
        ...
        beta=smoothPenalty*stepFactor*patchConnectNum;
        motion_update=getFlow3_withPenalty5(Ixx,Ixy,Ixz,Iyy,Iyz,Izz,Ixt,Iyt,Izt,motion_current,beta,r,zRatio);
