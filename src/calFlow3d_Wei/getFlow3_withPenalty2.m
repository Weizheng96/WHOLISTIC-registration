function phi_gradient=getFlow3_withPenalty2(Ixx,Ixy,Ixz,Iyy,Iyz,Izz,Ixt,Iyt,Izt,smoothPenaltySum,neiSum)
%% add penelty
Ixx=Ixx+smoothPenaltySum;
Iyy=Iyy+smoothPenaltySum;
Izz=Izz+smoothPenaltySum*27^2;
Ixt=Ixt+neiSum(:,:,:,1);
Iyt=Iyt+neiSum(:,:,:,2);
Izt=Izt+neiSum(:,:,:,3)*27^2;
%% get determinant 3*3
