function motion_current=getMotion_Wei_v15(dat_mov,dat_ref,smoothPenalty_raw)
%% v15: patch wise penalty
...
%         stepFactor=min((iter-1)/3,1);
        ...
        neiSum=smoothPenalty*stepFactor*getNeiSum2(motion_current(xG,yG,zG,:),1)/8*patchConnectNum;
