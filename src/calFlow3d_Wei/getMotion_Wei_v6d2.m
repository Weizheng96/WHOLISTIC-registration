function phi_current=getMotion_Wei_v6d2(dat_mov,dat_ref,smoothPenalty)
%% v6: new gradient calculation
...
for layer = layer_num:-1:0
    ...
    for iter = 1:iterNum
        ...
        stepFactor=1;
        neiSum=smoothPenalty*stepFactor*(getNeiSum2(phi_current,r)-phi_current*((2*r+1)^2-1));
        ...
        penaltyCorrected=sum(penaltyRaw.^2,4);
        penaltyError=gather(mean(penaltyCorrected*smoothPenalty,'all'));
