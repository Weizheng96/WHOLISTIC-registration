function motion_current=getMotion_Wei_v14d1(dat_mov,dat_ref,smoothPenalty_raw)
%% v14: change the smooth penalty
...
%         stepFactor=min((iter-1)/3,1);
        ...
        neiSum=smoothPenalty*stepFactor*patchConnectNum*(getNeiSum2(motion_current,r)/(patchConnectNum-1)-motion_current);
        neiSum=neiSum(xG,yG,zG,:);
    
        motion_update=getFlow3_withPenalty3(Ixx,Ixy,Ixz,Iyy,Iyz,Izz,Ixt,Iyt,Izt,smoothPenaltySum,neiSum,zRatio);
%         motion_update=motion_update/2;
