function [motion_current,currentError,x_new,y_new,z_new]=getMotionHZR_Wei_v2d2(dat_mov,dat_ref,smoothPenalty_raw,option)
...
%     fprintf("\nDownsample:"+layer+"\n");
    for iter = 1:iterNum
        ...
        data1_tran=correctMotion_Wei_v3(data1,x_new,y_new,z_new);  
