...
%% file path
filePath="/work/public/Virginia Rutten/230324_f479_ubi_gcamp_bactin2_mcherry_9dpf_hypoxia_tiles" + ...
    "/imag_tiles/res";
resPathName="/work/public/Virginia Rutten/230324_f479_ubi_gcamp_bactin2_mcherry_9dpf_hypoxia_tiles/f479_HZRv2d2_r5p1";
%% parameters
option.layer=3;
option.iter=10;
option.r=5;
...
%         dat_ref=updateFloatingTemplate_v3(dat_ref,dat_anaref_norm,thresFactor,optionTemplate,smoothPenaltyTemplate);
    ...
    dat_corrected1(:,:,:,tCnt)=correctMotion_Wei_v2(single(permute(dat(:,1,:,:),[3 4 1 2])),motion_current);
